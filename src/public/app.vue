  ...
  <div>
      <div class="header">
        <div class="header-contacts">
                  <div class="header-logo"><img class="logo-img" src="img/ЛогоТЕМП-01 (1) (1).png" alt="logo"></div>
                  <div class="header-message">У каждого кофе свой темп!</div>
                  <div class="header-contacts-tel">
            <span class="tel-1">+7 (831) 2-160-100</span>
            <span class="address">Пискунова, 24</span>
        </div>
        </div>
        
        <div class="header-nav-wrp">
            <nav class="header-nav">
                <label class="header-nav-label" for="header-nav-menu"></label>
                <input id="header-nav-menu" type="checkbox">
                ...
                <ul class="header-nav-menu">
                    ...
                    <li> <a href="#" class="header-nav-link">Команда</a></li>
                    <li> <a href="#" class="header-nav-link">Магазин</a></li>
                    <li> <a href="#" class="header-nav-link">Обжарка</a></li>
            ...
            <button class="header-cart-btn">
                <svg class="header-cart-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="27" viewBox="0 0 20 27">
